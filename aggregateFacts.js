...
var mapRelays = function() {
	var relays = {
		...
		servers.relays.roleAll.flagNone.count : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleAll.flagNone.bwa : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleAll.flagNone.bwc : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleAll.flagNone.osv.linux : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleAll.flagNone.osv.darwin : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleAll.flagNone.osv.freebsd : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleAll.flagNone.osv.windows : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleAll.flagNone.osv.other : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleAll.flagNone.tsv.010 : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleAll.flagNone.tsv.011 : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleAll.flagNone.tsv.012 : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleAll.flagNone.tsv.020 : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleAll.flagNone.tsv.021 : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleAll.flagNone.tsv.022 : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleAll.flagNone.tsv.023 : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleAll.flagNone.tsv.024 : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleAll.flagNone.pbr : (!(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.pbr : 0.0 ,
		
		servers.relays.roleAll.flagStable.count : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleAll.flagStable.bwa : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleAll.flagStable.bwc : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleAll.flagStable.osv.linux : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleAll.flagStable.osv.darwin : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleAll.flagStable.osv.freebsd : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleAll.flagStable.osv.windows : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleAll.flagStable.osv.other : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleAll.flagStable.tsv.010 : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleAll.flagStable.tsv.011 : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleAll.flagStable.tsv.012 : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleAll.flagStable.tsv.020 : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleAll.flagStable.tsv.021 : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleAll.flagStable.tsv.022 : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleAll.flagStable.tsv.023 : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleAll.flagStable.tsv.024 : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleAll.flagStable.pbr : (!(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.pbr : 0.0 ,
		
		servers.relays.roleAll.flagFast.count : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleAll.flagFast.bwa : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleAll.flagFast.bwc : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleAll.flagFast.osv.linux : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleAll.flagFast.osv.darwin : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleAll.flagFast.osv.freebsd : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleAll.flagFast.osv.windows : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleAll.flagFast.osv.other : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleAll.flagFast.tsv.010 : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleAll.flagFast.tsv.011 : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleAll.flagFast.tsv.012 : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleAll.flagFast.tsv.020 : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleAll.flagFast.tsv.021 : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleAll.flagFast.tsv.022 : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleAll.flagFast.tsv.023 : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleAll.flagFast.tsv.024 : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleAll.flagFast.pbr : ((flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.pbr : 0.0 ,

		servers.relays.roleAll.flagFastStable.count : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleAll.flagFastStable.bwa : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleAll.flagFastStable.bwc : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleAll.flagFastStable.osv.linux : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleAll.flagFastStable.osv.darwin : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleAll.flagFastStable.osv.freebsd : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleAll.flagFastStable.osv.windows : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleAll.flagFastStable.osv.other : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleAll.flagFastStable.tsv.010 : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleAll.flagFastStable.tsv.011 : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleAll.flagFastStable.tsv.012 : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleAll.flagFastStable.tsv.020 : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleAll.flagFastStable.tsv.021 : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleAll.flagFastStable.tsv.022 : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleAll.flagFastStable.tsv.023 : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleAll.flagFastStable.tsv.024 : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleAll.flagFastStable.pbr : ((flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.pbr : 0.0 ,			
		...
		servers.relays.roleGuard.flagNone.count : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleGuard.flagNone.bwa : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleGuard.flagNone.bwc : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleGuard.flagNone.osv.linux : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleGuard.flagNone.osv.darwin : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleGuard.flagNone.osv.freebsd : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleGuard.flagNone.osv.windows : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleGuard.flagNone.osv.other : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleGuard.flagNone.tsv.010 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleGuard.flagNone.tsv.011 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleGuard.flagNone.tsv.012 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleGuard.flagNone.tsv.020 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleGuard.flagNone.tsv.021 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleGuard.flagNone.tsv.022 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleGuard.flagNone.tsv.023 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleGuard.flagNone.tsv.024 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleGuard.flagNone.pbg : (this.role == "guard" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.pbg : 0.0 ,
		
		servers.relays.roleGuard.flagStable.count : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleGuard.flagStable.bwa : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleGuard.flagStable.bwc : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleGuard.flagStable.osv.linux : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleGuard.flagStable.osv.darwin : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleGuard.flagStable.osv.freebsd : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleGuard.flagStable.osv.windows : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleGuard.flagStable.osv.other : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleGuard.flagStable.tsv.010 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleGuard.flagStable.tsv.011 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleGuard.flagStable.tsv.012 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleGuard.flagStable.tsv.020 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleGuard.flagStable.tsv.021 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleGuard.flagStable.tsv.022 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleGuard.flagStable.tsv.023 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleGuard.flagStable.tsv.024 : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleGuard.flagStable.pbg : (this.role == "guard" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.pbg : 0.0 ,			
		
		servers.relays.roleGuard.flagFast.count : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleGuard.flagFast.bwa : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleGuard.flagFast.bwc : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleGuard.flagFast.osv.linux : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleGuard.flagFast.osv.darwin : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleGuard.flagFast.osv.freebsd : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleGuard.flagFast.osv.windows : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleGuard.flagFast.osv.other : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleGuard.flagFast.tsv.010 : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleGuard.flagFast.tsv.011 : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleGuard.flagFast.tsv.012 : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleGuard.flagFast.tsv.020 : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleGuard.flagFast.tsv.021 : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleGuard.flagFast.tsv.022 : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleGuard.flagFast.tsv.023 : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleGuard.flagFast.tsv.024 : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleGuard.flagFast.pbg : (this.role == "guard" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.pbg : 0.0 ,

		servers.relays.roleGuard.flagFastStable.count : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleGuard.flagFastStable.bwa : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleGuard.flagFastStable.bwc : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleGuard.flagFastStable.osv.linux : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleGuard.flagFastStable.osv.darwin : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleGuard.flagFastStable.osv.freebsd : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleGuard.flagFastStable.osv.windows : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleGuard.flagFastStable.osv.other : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleGuard.flagFastStable.tsv.010 : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleGuard.flagFastStable.tsv.011 : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleGuard.flagFastStable.tsv.012 : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleGuard.flagFastStable.tsv.020 : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleGuard.flagFastStable.tsv.021 : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleGuard.flagFastStable.tsv.022 : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleGuard.flagFastStable.tsv.023 : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleGuard.flagFastStable.tsv.024 : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleGuard.flagFastStable.pbg : (this.role == "guard" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.pbg : 0.0 ,
		...
		servers.relays.roleMiddle.flagNone.count : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleMiddle.flagNone.bwa : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleMiddle.flagNone.bwc : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleMiddle.flagNone.osv.linux : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleMiddle.flagNone.osv.darwin : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleMiddle.flagNone.osv.freebsd : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleMiddle.flagNone.osv.windows : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleMiddle.flagNone.osv.other : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleMiddle.flagNone.tsv.010 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleMiddle.flagNone.tsv.011 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleMiddle.flagNone.tsv.012 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleMiddle.flagNone.tsv.020 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleMiddle.flagNone.tsv.021 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleMiddle.flagNone.tsv.022 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleMiddle.flagNone.tsv.023 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleMiddle.flagNone.tsv.024 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleMiddle.flagNone.pbm : (this.role == "middle" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.pbm : 0.0 ,
		
		servers.relays.roleMiddle.flagStable.count : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleMiddle.flagStable.bwa : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleMiddle.flagStable.bwc : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleMiddle.flagStable.osv.linux : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleMiddle.flagStable.osv.darwin : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleMiddle.flagStable.osv.freebsd : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleMiddle.flagStable.osv.windows : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleMiddle.flagStable.osv.other : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleMiddle.flagStable.tsv.010 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleMiddle.flagStable.tsv.011 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleMiddle.flagStable.tsv.012 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleMiddle.flagStable.tsv.020 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleMiddle.flagStable.tsv.021 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleMiddle.flagStable.tsv.022 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleMiddle.flagStable.tsv.023 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleMiddle.flagStable.tsv.024 : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleMiddle.flagStable.pbm : (this.role == "middle" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.pbm : 0.0 ,
					
		servers.relays.roleMiddle.flagFast.count : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleMiddle.flagFast.bwa : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleMiddle.flagFast.bwc : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleMiddle.flagFast.osv.linux : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFast.osv.darwin : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFast.osv.freebsd : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFast.osv.windows : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFast.osv.other : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFast.tsv.010 : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFast.tsv.011 : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFast.tsv.012 : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFast.tsv.020 : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFast.tsv.021 : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFast.tsv.022 : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFast.tsv.023 : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFast.tsv.024 : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFast.pbm : (this.role == "middle" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.pbm : 0.0 ,

		servers.relays.roleMiddle.flagFastStable.count : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleMiddle.flagFastStable.bwa : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleMiddle.flagFastStable.bwc : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleMiddle.flagFastStable.osv.linux : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFastStable.osv.darwin : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFastStable.osv.freebsd : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFastStable.osv.windows : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFastStable.osv.other : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFastStable.tsv.010 : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFastStable.tsv.011 : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFastStable.tsv.012 : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFastStable.tsv.020 : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFastStable.tsv.021 : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFastStable.tsv.022 : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFastStable.tsv.023 : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFastStable.tsv.024 : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleMiddle.flagFastStable.pbm : (this.role == "middle" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.pbm : 0.0 ,
		...
		servers.relays.roleExit.flagNone.count : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleExit.flagNone.bwa : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleExit.flagNone.bwc : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleExit.flagNone.osv.linux : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleExit.flagNone.osv.darwin : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleExit.flagNone.osv.freebsd : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleExit.flagNone.osv.windows : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleExit.flagNone.osv.other : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleExit.flagNone.tsv.010 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleExit.flagNone.tsv.011 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleExit.flagNone.tsv.012 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleExit.flagNone.tsv.020 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleExit.flagNone.tsv.021 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleExit.flagNone.tsv.022 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleExit.flagNone.tsv.023 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleExit.flagNone.tsv.024 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleExit.flagNone.pex.4 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.pex == [443]) ? 1 : 0 ,
		servers.relays.roleExit.flagNone.pex.6 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.pex == [6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagNone.pex.8 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.pex == [80]) ? 1 : 0 ,
		servers.relays.roleExit.flagNone.pex.46 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.pex == [443, 6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagNone.pex.48 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.pex == [80, 443]) ? 1 : 0 ,
		servers.relays.roleExit.flagNone.pex.68 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.pex == [80, 6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagNone.pex.468 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.pex == [80, 443, 6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagNone.pbe : (this.role == "exit" && !(flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.pbe : 0.0 ,
		
		servers.relays.roleExit.flagFast.count : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleExit.flagFast.bwa : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleExit.flagFast.bwc : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleExit.flagFast.osv.linux : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleExit.flagFast.osv.darwin : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleExit.flagFast.osv.freebsd : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleExit.flagFast.osv.windows : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleExit.flagFast.osv.other : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleExit.flagFast.tsv.010 : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleExit.flagFast.tsv.011 : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleExit.flagFast.tsv.012 : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleExit.flagFast.tsv.020 : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleExit.flagFast.tsv.021 : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleExit.flagFast.tsv.022 : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleExit.flagFast.tsv.023 : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleExit.flagFast.tsv.024 : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleExit.flagFast.pex.4 : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.pex == [443]) ? 1 : 0 ,
		servers.relays.roleExit.flagFast.pex.6 : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.pex == [6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagFast.pex.8 : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.pex == [80]) ? 1 : 0 ,
		servers.relays.roleExit.flagFast.pex.46 : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.pex == [443, 6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagFast.pex.48 : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.pex == [80, 443]) ? 1 : 0 ,
		servers.relays.roleExit.flagFast.pex.68 : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.pex == [80, 6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagFast.pex.468 : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1) && this.pex == [80, 443, 6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagFast.pbe : (this.role == "exit" && (flag.indexOf('fast') > -1) && !(flag.indexOf('stable') > -1)) ? this.pbe : 0.0 ,
		
		servers.relays.roleExit.flagStable.count : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleExit.flagStable.bwa : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleExit.flagStable.bwc : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleExit.flagStable.osv.linux : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleExit.flagStable.osv.darwin : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleExit.flagStable.osv.freebsd : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleExit.flagStable.osv.windows : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleExit.flagStable.osv.other : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleExit.flagStable.tsv.010 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleExit.flagStable.tsv.011 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleExit.flagStable.tsv.012 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleExit.flagStable.tsv.020 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleExit.flagStable.tsv.021 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleExit.flagStable.tsv.022 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleExit.flagStable.tsv.023 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleExit.flagStable.tsv.024 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleExit.flagStable.pex.4 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.pex == [443]) ? 1 : 0 ,
		servers.relays.roleExit.flagStable.pex.6 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.pex == [6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagStable.pex.8 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.pex == [80]) ? 1 : 0 ,
		servers.relays.roleExit.flagStable.pex.46 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.pex == [443, 6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagStable.pex.48 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.pex == [80, 443]) ? 1 : 0 ,
		servers.relays.roleExit.flagStable.pex.68 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.pex == [80, 6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagStable.pex.468 : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.pex == [80, 443, 6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagStable.pbe : (this.role == "exit" && !(flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.pbe : 0.0 ,
		
		servers.relays.roleExit.flagFastStable.count : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.bwa : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwa : 0 ,
		servers.relays.roleExit.flagFastStable.bwc : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.bwc : 0 ,
		servers.relays.roleExit.flagFastStable.osv.linux : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "linux") ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.osv.darwin : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "darwin") ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.osv.freebsd : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "freebsd") ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.osv.windows : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "windows") ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.osv.other : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.osv == "other") ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.tsv.010 : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "010") ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.tsv.011 : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "011") ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.tsv.012 : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "012") ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.tsv.020 : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "020") ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.tsv.021 : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "021") ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.tsv.022 : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "022") ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.tsv.023 : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "023") ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.tsv.024 : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.tsv == "024") ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.pex.4 : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.pex == [443]) ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.pex.6 : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.pex == [6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.pex.8 : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.pex == [80]) ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.pex.46 : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.pex == [443, 6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.pex.48 : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.pex == [80, 443]) ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.pex.68 : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.pex == [80, 6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.pex.468 : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1) && this.pex == [80, 443, 6667]) ? 1 : 0 ,
		servers.relays.roleExit.flagFastStable.pbe : (this.role == "exit" && (flag.indexOf('fast') > -1) && (flag.indexOf('stable') > -1)) ? this.pbe : 0.0 ,		
