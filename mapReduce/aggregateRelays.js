	...
	var map = {
		servers : {
			relays : {
				...
				roleGuard : {
					total : {
						count : (this.role.indexOf("Guard") > -1) ? 1 : 0 ,
						bwa : (this.role.indexOf("Guard") > -1) ? this.bwa : 0 ,
						bwc : (this.role.indexOf("Guard") > -1) ? this.bwc : 0 ,
						osv : {
							linux : (this.role.indexOf("Guard") > -1 && this.osv == "linux") ? 1 : 0 ,
							darwin : (this.role.indexOf("Guard") > -1 && this.osv == "darwin") ? 1 : 0 ,
							freebsd : (this.role.indexOf("Guard") > -1 && this.osv == "freebsd") ? 1 : 0 ,
							windows : (this.role.indexOf("Guard") > -1 && this.osv == "windows") ? 1 : 0 ,
							other : (this.role.indexOf("Guard") > -1 && this.osv == "other") ? 1 : 0
						} ,
						tsv : {
							v010 : (this.role.indexOf("Guard") > -1 && this.tsv == "010") ? 1 : 0 ,
							v011 : (this.role.indexOf("Guard") > -1 && this.tsv == "011") ? 1 : 0 ,
							v012 : (this.role.indexOf("Guard") > -1 && this.tsv == "012") ? 1 : 0 ,
							v020 : (this.role.indexOf("Guard") > -1 && this.tsv == "020") ? 1 : 0 ,
							v021 : (this.role.indexOf("Guard") > -1 && this.tsv == "021") ? 1 : 0 ,
							v022 : (this.role.indexOf("Guard") > -1 && this.tsv == "022") ? 1 : 0 ,
							v023 : (this.role.indexOf("Guard") > -1 && this.tsv == "023") ? 1 : 0 ,
							v024 : (this.role.indexOf("Guard") > -1 && this.tsv == "024") ? 1 : 0
						} ,
						pbg : (this.role.indexOf("Guard") > -1) ? this.pbg : 0.0
					} ,
					flagNone : {
						count : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1) ? 1 : 0 ,
						bwa : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1) ? this.bwa : 0 ,
						bwc : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1) ? this.bwc : 0 ,
						osv : {
							linux : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.osv == "linux") ? 1 : 0 ,
							darwin : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.osv == "darwin") ? 1 : 0 ,
							freebsd : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.osv == "freebsd") ? 1 : 0 ,
							windows : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.osv == "windows") ? 1 : 0 ,
							other : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.osv == "other") ? 1 : 0
						} ,
						tsv : {
							v010 : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "010") ? 1 : 0 ,
							v011 : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "011") ? 1 : 0 ,
							v012 : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "012") ? 1 : 0 ,
							v020 : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "020") ? 1 : 0 ,
							v021 : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "021") ? 1 : 0 ,
							v022 : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "022") ? 1 : 0 ,
							v023 : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "023") ? 1 : 0 ,
							v024 : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "024") ? 1 : 0
						} ,
						pbg : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1) ? this.pbg : 0.0
					} ,
					flagStable : {
						count : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") > -1) ? 1 : 0 ,
						bwa : (this.role.indexOf("Guard") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") > -1) ? this.bwa : 0 ,
				...
				roleMiddle : {
					total : {
						count : (this.role.indexOf("Middle") > -1) ? 1 : 0 ,
						bwa : (this.role.indexOf("Middle") > -1) ? this.bwa : 0 ,
						bwc : (this.role.indexOf("Middle") > -1) ? this.bwc : 0 ,
						osv : {
							linux : (this.role.indexOf("Middle") > -1 && this.osv == "linux") ? 1 : 0 ,
							darwin : (this.role.indexOf("Middle") > -1 && this.osv == "darwin") ? 1 : 0 ,
							freebsd : (this.role.indexOf("Middle") > -1 && this.osv == "freebsd") ? 1 : 0 ,
							windows : (this.role.indexOf("Middle") > -1 && this.osv == "windows") ? 1 : 0 ,
							other : (this.role.indexOf("Middle") > -1 && this.osv == "other") ? 1 : 0
						} ,
						tsv : {
							v010 : (this.role.indexOf("Middle") > -1 && this.tsv == "010") ? 1 : 0 ,
							v011 : (this.role.indexOf("Middle") > -1 && this.tsv == "011") ? 1 : 0 ,
							v012 : (this.role.indexOf("Middle") > -1 && this.tsv == "012") ? 1 : 0 ,
							v020 : (this.role.indexOf("Middle") > -1 && this.tsv == "020") ? 1 : 0 ,
							v021 : (this.role.indexOf("Middle") > -1 && this.tsv == "021") ? 1 : 0 ,
							v022 : (this.role.indexOf("Middle") > -1 && this.tsv == "022") ? 1 : 0 ,
							v023 : (this.role.indexOf("Middle") > -1 && this.tsv == "023") ? 1 : 0 ,
							v024 : (this.role.indexOf("Middle") > -1 && this.tsv == "024") ? 1 : 0 
						} ,
						pbm : (this.role.indexOf("Middle") > -1) ? this.pbm : 0.0
					} ,
					flagNone : {
						count : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1) ? 1 : 0 ,
						bwa : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1) ? this.bwa : 0 ,
						bwc : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1) ? this.bwc : 0 ,
						osv : {
							linux : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.osv == "linux") ? 1 : 0 ,
							darwin : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.osv == "darwin") ? 1 : 0 ,
							freebsd : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.osv == "freebsd") ? 1 : 0 ,
							windows : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.osv == "windows") ? 1 : 0 ,
							other : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.osv == "other") ? 1 : 0
						} ,
						tsv : {
							v010 : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "010") ? 1 : 0 ,
							v011 : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "011") ? 1 : 0 ,
							v012 : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "012") ? 1 : 0 ,
							v020 : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "020") ? 1 : 0 ,
							v021 : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "021") ? 1 : 0 ,
							v022 : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "022") ? 1 : 0 ,
							v023 : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "023") ? 1 : 0 ,
							v024 : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "024") ? 1 : 0
						} ,
						pbm : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1) ? this.pbm : 0.0
					} ,
					flagStable : {
						count : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") > -1) ? 1 : 0 ,
						bwa : (this.role.indexOf("Middle") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") > -1) ? this.bwa : 0 ,
				...
				roleExit : {
					total : {
						count : (this.role.indexOf("Exit") > -1) ? 1 : 0 ,
						bwa : (this.role.indexOf("Exit") > -1) ? this.bwa : 0 ,
						bwc : (this.role.indexOf("Exit") > -1) ? this.bwc : 0 ,
						osv : {
							linux : (this.role.indexOf("Exit") > -1 && this.osv == "linux") ? 1 : 0 ,
							darwin : (this.role.indexOf("Exit") > -1 && this.osv == "darwin") ? 1 : 0 ,
							freebsd : (this.role.indexOf("Exit") > -1 && this.osv == "freebsd") ? 1 : 0 ,
							windows : (this.role.indexOf("Exit") > -1 && this.osv == "windows") ? 1 : 0 ,
							other : (this.role.indexOf("Exit") > -1 && this.osv == "other") ? 1 : 0
						} ,
						tsv : {
							v010 : (this.role.indexOf("Exit") > -1 && this.tsv == "010") ? 1 : 0 ,
							v011 : (this.role.indexOf("Exit") > -1 && this.tsv == "011") ? 1 : 0 ,
							v012 : (this.role.indexOf("Exit") > -1 && this.tsv == "012") ? 1 : 0 ,
							v020 : (this.role.indexOf("Exit") > -1 && this.tsv == "020") ? 1 : 0 ,
							v021 : (this.role.indexOf("Exit") > -1 && this.tsv == "021") ? 1 : 0 ,
							v022 : (this.role.indexOf("Exit") > -1 && this.tsv == "022") ? 1 : 0 ,
							v023 : (this.role.indexOf("Exit") > -1 && this.tsv == "023") ? 1 : 0 ,
							v024 : (this.role.indexOf("Exit") > -1 && this.tsv == "024") ? 1 : 0
						} ,
						pex : {
							p4 : (this.role.indexOf("Exit") > -1 && this.pex.indexOf(443) > -1) ? 1 : 0 ,
							p6 : (this.role.indexOf("Exit") > -1 && this.pex.indexOf(6667) > -1) ? 1 : 0 ,
							p8 : (this.role.indexOf("Exit") > -1 && this.pex.indexOf(80) > -1) ? 1 : 0 ,
							p46 : (this.role.indexOf("Exit") > -1 && this.pex.indexOf(443) > -1 && this.pex.indexOf(6667) > -1) ? 1 : 0 ,
							p48 : (this.role.indexOf("Exit") > -1 && this.pex.indexOf(80) > -1 && this.pex.indexOf(443) > -1) ? 1 : 0 ,
							p68 : (this.role.indexOf("Exit") > -1 && this.pex.indexOf(80) > -1 && this.pex.indexOf(6667) > -1) ? 1 : 0 ,
							p468 : (this.role.indexOf("Exit") > -1 && this.pex.indexOf(80) > -1 && this.pex.indexOf(443) > -1 && this.pex.indexOf(6667) > -1) ? 1 : 0
						} ,
						pbe : (this.role.indexOf("Exit") > -1) ? this.pbe : 0.0
					} ,
					flagNone : {
						count : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1) ? 1 : 0 ,
						bwa : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1) ? this.bwa : 0 ,
						bwc : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1) ? this.bwc : 0 ,
						osv : {
							linux : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.osv == "linux") ? 1 : 0 ,
							darwin : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.osv == "darwin") ? 1 : 0 ,
							freebsd : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.osv == "freebsd") ? 1 : 0 ,
							windows : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.osv == "windows") ? 1 : 0 ,
							other : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.osv == "other") ? 1 : 0
						} ,
						tsv : {
							v010 : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "010") ? 1 : 0 ,
							v011 : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "011") ? 1 : 0 ,
							v012 : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "012") ? 1 : 0 ,
							v020 : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "020") ? 1 : 0 ,
							v021 : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "021") ? 1 : 0 ,
							v022 : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "022") ? 1 : 0 ,
							v023 : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "023") ? 1 : 0 ,
							v024 : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.tsv == "024") ? 1 : 0
						} ,
						pex : {
							p4 : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.pex.indexOf(443) > -1) ? 1 : 0 ,
							p6 : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.pex.indexOf(6667) > -1) ? 1 : 0 ,
							p8 : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.pex.indexOf(80) > -1) ? 1 : 0 ,
							p46 : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.pex.indexOf(443) > -1 && this.pex.indexOf(6667) > -1) ? 1 : 0 ,
							p48 : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.pex.indexOf(80) > -1 && this.pex.indexOf(443) > -1) ? 1 : 0 ,
							p68 : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.pex.indexOf(80) > -1 && this.pex.indexOf(6667) > -1) ? 1 : 0 ,
							p468 : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1 && this.pex.indexOf(80) > -1 && this.pex.indexOf(443) > -1 && this.pex.indexOf(6667) > -1) ? 1 : 0
						} ,
						pbe : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") == -1 && this.flag.indexOf("Stable") == -1) ? this.pbe : 0.0
					} ,
					flagFast : {
						count : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") > -1 && this.flag.indexOf("Stable") == -1) ? 1 : 0 ,
						bwa : (this.role.indexOf("Exit") > -1 && this.flag.indexOf("Fast") > -1 && this.flag.indexOf("Stable") == -1) ? this.bwa : 0 ,
				...
				roleDir : {
					total : {
						count : (this.role.indexOf("Dir") > -1) ? 1 : 0 ,
						bwa : (this.role.indexOf("Dir") > -1) ? this.bwa : 0 ,
						bwc : (this.role.indexOf("Dir") > -1) ? this.bwc : 0 ,
						osv : {
							linux : (this.role.indexOf("Dir") > -1 && this.osv == "linux") ? 1 : 0 ,
							darwin : (this.role.indexOf("Dir") > -1 && this.osv == "darwin") ? 1 : 0 ,
							freebsd : (this.role.indexOf("Dir") > -1 && this.osv == "freebsd") ? 1 : 0 ,
							windows : (this.role.indexOf("Dir") > -1 && this.osv == "windows") ? 1 : 0 ,
							other : (this.role.indexOf("Dir") > -1 && this.osv == "other") ? 1 : 0
						} ,
						tsv : {
							v010 : (this.role.indexOf("Dir") > -1 && this.tsv == "010") ? 1 : 0 ,
							v011 : (this.role.indexOf("Dir") > -1 && this.tsv == "011") ? 1 : 0 ,
							v012 : (this.role.indexOf("Dir") > -1 && this.tsv == "012") ? 1 : 0 ,
							v020 : (this.role.indexOf("Dir") > -1 && this.tsv == "020") ? 1 : 0 ,
							v021 : (this.role.indexOf("Dir") > -1 && this.tsv == "021") ? 1 : 0 ,
							v022 : (this.role.indexOf("Dir") > -1 && this.tsv == "022") ? 1 : 0 ,
							v023 : (this.role.indexOf("Dir") > -1 && this.tsv == "023") ? 1 : 0 ,
							v024 : (this.role.indexOf("Dir") > -1 && this.tsv == "024") ? 1 : 0
						}		
					} ,
					authorityTrue : {
						count : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1) ? 1 : 0 ,
						bwa : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1) ? this.bwa : 0 ,
						bwc : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1) ? this.bwc : 0 ,
						osv : {
							linux : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1 && this.osv == "linux") ? 1 : 0 ,
							darwin : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1 && this.osv == "darwin") ? 1 : 0 ,
							freebsd : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1 && this.osv == "freebsd") ? 1 : 0 ,
							windows : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1 && this.osv == "windows") ? 1 : 0 ,
							other : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1 && this.osv == "other") ? 1 : 0
						} ,
						tsv : {
							v010 : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1 && this.tsv == "010") ? 1 : 0 ,
							v011 : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1 && this.tsv == "011") ? 1 : 0 ,
							v012 : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1 && this.tsv == "012") ? 1 : 0 ,
							v020 : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1 && this.tsv == "020") ? 1 : 0 ,
							v021 : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1 && this.tsv == "021") ? 1 : 0 ,
							v022 : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1 && this.tsv == "022") ? 1 : 0 ,
							v023 : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1 && this.tsv == "023") ? 1 : 0 ,
							v024 : (this.role.indexOf("Dir") > -1 && this.flag.indexOf("Authority") > -1 && this.tsv == "024") ? 1 : 0
						}
					}
				}
			}
